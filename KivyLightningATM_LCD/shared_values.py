...
class SharedValues:
    ...
    BTCPAY_URL = '<YOUR BTCPAYSERVER REST API PATH>'

    # admin macaroon in hex format
    LND_MACAROON = '<YOUR ADMIN MACAROON>'
    ...
    # necessary to decide if  popup was close by 'continue payment' or 'cancel payment'
    payment_canceled = True

    # necessary to share and save the information if a button was pressed or not
